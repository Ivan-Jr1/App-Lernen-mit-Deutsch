// Marca do app: um flashcard virando (deck de cartões) na cor de destaque indigo.
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="size-full">
        ...
        <rect x="7" y="9" width="7.2" height="1.7" rx="0.85" fill="#c7d2fe" />
        <rect x="7" y="12.4" width="4.8" height="1.7" rx="0.85" fill="#c7d2fe" />
      </svg>
    </span>
  )
}
